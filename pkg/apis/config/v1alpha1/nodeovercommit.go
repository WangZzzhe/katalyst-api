...
type NodeOvercommitConfigSpec struct {
	// Type determines the scope of the config
	// default,labelSelector,nodeList are supported.
	// +kubebuilder:validation:Enum=default;labelSelector;nodeList
	Type string `json:"configType,omitempty"`
...
type NodeOvercommitConfigType string

const (
	DefaultConfigType NodeOvercommitConfigType = "default"
	LabelSelector     NodeOvercommitConfigType = "labelSelector"
	NodeList          NodeOvercommitConfigType = "nodeList"
)

// NodeOvercommitConfigStatus defines the observed state of NodeOvercommitConfig
