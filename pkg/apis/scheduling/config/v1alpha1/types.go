...
type QoSAwareNodeResourcesBalancedAllocationArgs struct {
	...
	ReclaimedResources []v1.ResourceSpec `json:"reclaimedResources,omitempty"`
}
...
type ScoringStrategy struct {
	...
	RequestedToCapacityRatio *v1.RequestedToCapacityRatioArguments `json:"requestedToCapacityRatio,omitempty"`

	// Arguments specific to RequestedToCapacityRatio strategy.
	ReclaimedRequestedToCapacityRatio *v1.RequestedToCapacityRatioArguments `json:"reclaimedRequestedToCapacityRatio,omitempty"`
}
