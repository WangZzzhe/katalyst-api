...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case configv1alpha1.SchemeGroupVersion.WithResource("nodeovercommitconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Config().V1alpha1().NodeOvercommitConfigs().Informer()}, nil
