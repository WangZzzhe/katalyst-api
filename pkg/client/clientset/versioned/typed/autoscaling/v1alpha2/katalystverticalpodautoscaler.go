...
type KatalystVerticalPodAutoscalerInterface interface {
	Create(*v1alpha2.KatalystVerticalPodAutoscaler) (*v1alpha2.KatalystVerticalPodAutoscaler, error)
	Update(*v1alpha2.KatalystVerticalPodAutoscaler) (*v1alpha2.KatalystVerticalPodAutoscaler, error)
	UpdateStatus(*v1alpha2.KatalystVerticalPodAutoscaler) (*v1alpha2.KatalystVerticalPodAutoscaler, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.KatalystVerticalPodAutoscaler, error)
	List(opts v1.ListOptions) (*v1alpha2.KatalystVerticalPodAutoscalerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.KatalystVerticalPodAutoscaler, err error)
...
func (c *katalystVerticalPodAutoscalers) Get(name string, options v1.GetOptions) (result *v1alpha2.KatalystVerticalPodAutoscaler, err error) {
...
func (c *katalystVerticalPodAutoscalers) List(opts v1.ListOptions) (result *v1alpha2.KatalystVerticalPodAutoscalerList, err error) {
...
func (c *katalystVerticalPodAutoscalers) Create(katalystVerticalPodAutoscaler *v1alpha2.KatalystVerticalPodAutoscaler) (result *v1alpha2.KatalystVerticalPodAutoscaler, err error) {
	result = &v1alpha2.KatalystVerticalPodAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("katalystverticalpodautoscalers").
...
func (c *katalystVerticalPodAutoscalers) Update(katalystVerticalPodAutoscaler *v1alpha2.KatalystVerticalPodAutoscaler) (result *v1alpha2.KatalystVerticalPodAutoscaler, err error) {
	result = &v1alpha2.KatalystVerticalPodAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("katalystverticalpodautoscalers").
...
func (c *katalystVerticalPodAutoscalers) UpdateStatus(katalystVerticalPodAutoscaler *v1alpha2.KatalystVerticalPodAutoscaler) (result *v1alpha2.KatalystVerticalPodAutoscaler, err error) {
	result = &v1alpha2.KatalystVerticalPodAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("katalystverticalpodautoscalers").
...
func (c *katalystVerticalPodAutoscalers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.KatalystVerticalPodAutoscaler, err error) {
	result = &v1alpha2.KatalystVerticalPodAutoscaler{}
