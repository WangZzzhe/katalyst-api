...
./hack/generate-groups.sh all \
  ...
  "node:v1alpha1 recommendation:v1alpha1 autoscaling:v1alpha1,v1alpha2 config:v1alpha1 workload:v1alpha1 overcommit:v1alpha1 tide:v1alpha1 resourceportrait:v1alpha1" \
